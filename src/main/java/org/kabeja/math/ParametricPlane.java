...
public class ParametricPlane {
  ...
  public ParametricPlane( Point basePoint, Point b, Vector normal ) {
    this( basePoint, MathUtils.normalize( MathUtils.getVector( basePoint, b ) ),
      MathUtils.normalize( MathUtils.crossProduct( normal, MathUtils.normalize( MathUtils
        .getVector( basePoint, b ) ) ) ),
      normal );
  }
  ...
  public Point getBasePoint() { return base; }

  public void setBasePoint( Point base ) { this.base = base; }

  public Vector getDirectionX() { return directionX; }
