...
public class DXFViewportHandler extends AbstractEntityHandler {
  ...
  private int[] xDataConvert =
    new int[] { 1000, 1002, 1070, 17, 27, 37, 16, 26, 36, 51, 45, 12, 22, 42, 43, 44, 90, 72, 90, 90, 90, 90, 90, 90,
      50, 13, 23, 14, 24, 15, 25, 90, 1002
    };
  private DXFViewport viewport;
  private boolean convertXDATA = false;
  private int pos = 0;

  public String getDXFEntityName() { return DXFConstants.ENTITY_TYPE_VIEWPORT; }
  ...
  public DXFEntity getDXFEntity() { return this.viewport; }
