...
public class DXFPolylineHandler extends AbstractEntityHandler {
   ...
   */
  public String getDXFEntityName() { return DXFConstants.ENTITY_TYPE_POLYLINE; }
   ...
   */
  public DXFEntity getDXFEntity() { return polyline; }
   ...
   */
  public boolean isFollowSequence() { return follow; }
}
