...
public class DXFView {
   ...
   */
  public double getBackClipping() { return backClipping; }

  /**
   * @param backClipping The backClipping to set.
   */
  public void setBackClipping( double backClipping ) { this.backClipping = backClipping; }
   ...
   */
  public double getFrontClipping() { return frontClipping; }

  /**
   * @param frontClipping The frontClipping to set.
   */
  public void setFrontClipping( double frontClipping ) { this.frontClipping = frontClipping; }
   ...
   */
  public void setTwistAngle( double twistAngle ) { this.twistAngle = twistAngle; }
   ...
   */
  public Vector getViewDirection() { return viewDirection; }

  /**
   * @param viewDirection The viewDirection to set.
   */
  public void setViewDirection( Vector viewDirection ) { this.viewDirection = viewDirection; }
