...
public class DXFVPort {
   ...
   */
  public Point getViewDirectionPoint() { return viewDirectionPoint; }

  /**
   * @param viewDirectionPoint The viewDirectionPoint to set.
   */
  public void setViewDirectionPoint( Point viewDirectionPoint ) { this.viewDirectionPoint = viewDirectionPoint; }
   ...
   */
  public double getViewTwistAngle() { return viewTwistAngle; }

  /**
   * @param viewTwistAngle The viewTwistAngle to set.
   */
  public void setViewTwistAngle( double viewTwistAngle ) { this.viewTwistAngle = viewTwistAngle; }
