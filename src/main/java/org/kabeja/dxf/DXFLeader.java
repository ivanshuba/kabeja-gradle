...
public class DXFLeader extends DXFEntity {
   ...
   */
  public void setArrowHeadSize( double arrowHeadSize ) { this.arrowHeadSize = arrowHeadSize; }
   ...
   */
  public void setCreationType( int creationType ) { this.creationType = creationType; }
   ...
   */
  public void setHookline( boolean hookline ) { this.hookline = hookline; }
   ...
   */
  public void setHooklineDirecton( int hooklineDirecton ) { this.hooklineDirecton = hooklineDirecton; }
   ...
   */
  public void setLastOffsetText( Point lastOffsetText ) { this.lastOffsetText = lastOffsetText; }
   ...
   */
  public void setStyleNameID( String styleName ) { this.styleName = styleName; }
   ...
   */
  public void setTextGap( double textGap ) { this.textGap = textGap; }
   ...
   */
  public void setTextWidth( double textWidth ) { this.textWidth = textWidth; }
   ...
   */
  public void setArrowEnabled( boolean arrowEnabled ) { this.arrowEnabled = arrowEnabled; }
