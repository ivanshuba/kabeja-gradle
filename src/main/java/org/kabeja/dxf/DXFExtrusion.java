...
public class DXFExtrusion {
   ...
   */
  public double getX() { return n.getX(); }
   ...
   */
  public double getY() { return n.getY(); }
   ...
   */
  public double getZ() { return n.getZ(); }
   ...
   */
  public Vector getDirectionY() { return MathUtils.crossProduct( n, getDirectionX() ); }
   ...
   * @see getNormal()
   */
  public Vector getDirectionZ() { return n; }
}
