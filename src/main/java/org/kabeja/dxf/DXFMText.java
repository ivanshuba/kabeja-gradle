...
public class DXFMText extends DXFText {
   ...
   */
  public void setAttachmentPoint( int value ) { this.attachmentpointLocation = value; }

  public double getReferenceWidth() { return this.refwidth; }

  public void setReferenceWidth( double width ) { this.refwidth = width; }

  public int getAlignment() { return attachmentpointLocation; }
  ...
  public double getReferenceHeight() { return this.refheight; }

  public void setReferenceHeight( double height ) { this.refheight = height; }

  public String getType() { return DXFConstants.ENTITY_TYPE_MTEXT; }
