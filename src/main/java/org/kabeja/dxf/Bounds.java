...
public class Bounds {
   ...
   */
  public double getMaximumX() { return max_x; }

  /**
   * @param max_x The max_x to set.
   */
  public void setMaximumX( double max_x ) { this.max_x = max_x; }

  /**
   * @return Returns the min_x.
   */
  public double getMinimumX() { return min_x; }

  /**
   * @return Returns the max_y.
   */
  public double getMaximumY() { return max_y; }

  /**
   * @param max_y The max_y to set.
   */
  public void setMaximumY( double max_y ) { this.max_y = max_y; }

  /**
   * @return Returns the min_y.
   */
  public double getMinimumY() { return min_y; }

  /**
   * @param min_y The min_y to set.
   */
  public void setMinimumY( double min_y ) { this.min_y = min_y; }

  public double getMaximumZ() { return this.max_z; }

  public double getMinimumZ() { return this.min_z; }

  public void setMinimumZ( double min_z ) { this.min_z = min_z; }

  public void setMaximumZ( double max_z ) { this.max_z = max_z; }

  /**
   * @param min_x The min_x to set.
   */
  public void setMinimumX( double min_x ) { this.min_x = min_x; }
  ...
  public double getDepth() { return Math.abs( getMaximumZ() - getMinimumZ() ); }
   ...
   */
  public void setValid( boolean set ) { this.set = set; }
  ...
  public double getWidth() { return Math.abs( getMaximumX() - getMinimumX() ); }

  public double getHeight() { return Math.abs( getMaximumY() - getMinimumY() ); }
