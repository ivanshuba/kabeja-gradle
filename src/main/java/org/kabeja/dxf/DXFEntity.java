...
public abstract class DXFEntity {
   ...
   */
  public String getLayerName() { return this.layerID; }
   ...
   * @return the name of the layer
   */
  public void setLayerName( String id ) { this.layerID = id; }
  ...
  public boolean isBlockEntity() { return block; }

  public void setBlockEntity( boolean b ) { this.block = b; }

  public DXFExtrusion getExtrusion() { return extrusion; }

  public void setExtrusion( DXFExtrusion extrusion ) { this.extrusion = extrusion; }

  public double getLinetypeScaleFactor() { return linetypeScaleFactor; }

  public void setLinetypeScaleFactor( double linetypeScaleFactor ) { this.linetypeScaleFactor = linetypeScaleFactor; }

  public int getColor() { return color; }

  public void setColor( int color ) { this.color = color; }

  public byte[] getColorRGB() { return colorRGB; }

  public void setColorRGB( byte[] colorRGB ) { this.colorRGB = colorRGB; }
  ...
  public boolean isOmitLineType() { return false; }

  /**
   * @return Returns the modelSpace.
   */
  public boolean isModelSpace() { return modelSpace; }

  /**
   * @param modelSpace The modelSpace to set.
   */
  public void setModelSpace( boolean modelSpace ) { this.modelSpace = modelSpace; }
