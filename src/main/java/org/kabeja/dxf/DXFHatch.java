...
public class DXFHatch extends DXFEntity {
   ...
   */
  public void setAssociativityFlag( int associativityFlag ) { this.associativityFlag = associativityFlag; }
   ...
   */
  public void setBoundaryAnnotation( boolean boundaryAnnotation ) { this.boundaryAnnotation = boundaryAnnotation; }
   ...
   */
  public void setBoundaryPathCount( int boundaryPathCount ) { this.boundaryPathCount = boundaryPathCount; }
   ...
   */
  public void setGradientHatch( boolean gradientHatch ) { this.gradientHatch = gradientHatch; }
   ...
   */
  public void setOffsetVector( double offsetVector ) { this.offsetVector = offsetVector; }
   ...
   */
  public void setPatternAngle( double patternAngle ) { this.patternAngle = patternAngle; }
   ...
   */
  public void setPatternDouble( boolean patternDouble ) { this.patternDouble = patternDouble; }
   ...
   */
  public void setPatternType( int patternType ) { this.patternType = patternType; }
   ...
   */
  public void setSeedPointCount( int seedPointCount ) { this.seedPointCount = seedPointCount; }
   ...
   */
  public void setElevationPoint( Point elevationPoint ) { this.elevationPoint = elevationPoint; }
   ...
   */
  public void setDXFHatchPatternID( String patternID ) { this.patternID = patternID; }
