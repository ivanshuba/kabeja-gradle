...
public class DXFTolerance extends DXFEntity {
   ...
   */
  public Point getInsertionPoint() { return insertionPoint; }

  /**
   * @param insertionPoint The insertionPoint to set.
   */
  public void setInsertionPoint( Point insertionPoint ) { this.insertionPoint = insertionPoint; }

  /**
   * @return Returns the styleID.
   */
  public String getStyleID() { return styleNameID; }

  /**
   * @param styleNameID The styleID to set.
   */
  public void setStyleID( String styleNameID ) { this.styleNameID = styleNameID; }
   ...
   */
  public Vector getXaxisDirection() { return xaxisDirection; }

  /**
   * @param xaxisDirection The xaxisDirection to set.
   */
  public void setXaxisDirection( Vector xaxisDirection ) { this.xaxisDirection = xaxisDirection; }
}
