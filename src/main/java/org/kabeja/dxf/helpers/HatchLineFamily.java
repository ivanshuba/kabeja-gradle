...
public class HatchLineFamily {
  ...
  public double getPatternWidth() { return ( getLength() * Math.cos( this.rotationAngle ) ); }
  ...
  public double getPatternHeight() { return ( getLength() * Math.sin( this.rotationAngle ) ); }
  ...
  public Point getBasePoint() { return transform( this.baseX, this.baseY ); }

  public Point getOffsetPoint() { return transform( this.offsetX, this.offsetY ); }
