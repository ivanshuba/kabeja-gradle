...
public class SplinePoint extends Point {
   ...
   */
  public boolean isControlPoint() { return this.type == TYPE_CONTROLPOINT; }

  /**
   * @return Returns the endTangent.
   */
  public boolean isEndTangent() { return this.type == TYPE_ENDTANGENT; }

  /**
   * @return Returns the fitPoint.
   */
  public boolean isFitPoint() { return this.type == TYPE_FITPOINT; }

  /**
   * @return Returns the startTangent.
   */
  public boolean isStartTangent() { return this.type == TYPE_STARTTANGENT; }
