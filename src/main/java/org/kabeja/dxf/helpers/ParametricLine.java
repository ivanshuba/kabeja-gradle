...
public class ParametricLine {
  ...
  public double getIntersectionParameter( ParametricLine line ) {
    ...
    Vector m = MathUtils.crossProduct( MathUtils.getVector( this.startPoint, line.getStartPoint() ), line
      .getDirectionVector() );
    double s = 0;
  ...
  public Vector getDirectionVector() { return this.direction; }

  public Point getStartPoint() { return this.startPoint; }

  public void setStartPoint( Point start ) { this.startPoint = start; }

  public void setDirectionVector( Vector v ) { this.direction = v; }
