...
public class StyledTextParagraph {
   ...
   */
  public double getCharacterspace() { return characterspace; }

  /**
   * @param characterspace The characterspace to set.
   */
  public void setCharacterspace( double characterspace ) { this.characterspace = characterspace; }

  /**
   * @return Returns the alignment.
   */
  public int getValign() { return alignment; }

  /**
   * @param alignment The alignment to set.
   */
  public void setValign( int alignment ) { this.alignment = alignment; }
   ...
   */
  public double getFontHeight() { return fontHeight; }
   ...
   */
  public double getObliquiAngle() { return obliquiAngle; }

  /**
   * @param obliquiAngle The obliquiAngle to set.
   */
  public void setObliquiAngle( double obliquiAngle ) { this.obliquiAngle = obliquiAngle; }
   ...
   */
  public void setOverline( boolean overline ) { this.overline = overline; }
   ...
   */
  public void setLineIndex( int linecount ) { this.lineIndex = linecount; }
