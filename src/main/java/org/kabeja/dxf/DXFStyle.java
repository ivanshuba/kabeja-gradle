...
public class DXFStyle {
   ...
   */
  public String getBigFontFile() { return bigFontFile; }

  /**
   * @param bigFontFile The bigFontFile to set.
   */
  public void setBigFontFile( String bigFontFile ) { this.bigFontFile = bigFontFile; }
   ...
   */
  public void setLastHeight( double lastHeight ) { this.lastHeight = lastHeight; }
   ...
   */
  public double getObliqueAngle() { return obliqueAngle; }

  /**
   * @param obliqueAngle The obliqueAngle to set.
   */
  public void setObliqueAngle( double obliqueAngle ) { this.obliqueAngle = obliqueAngle; }

  /**
   * @return Returns the textGenerationFlag.
   */
  public int getTextGenerationFlag() { return textGenerationFlag; }

  /**
   * @param textGenerationFlag The textGenerationFlag to set.
   */
  public void setTextGenerationFlag( int textGenerationFlag ) { this.textGenerationFlag = textGenerationFlag; }
  ...
  public boolean isBackward() { return this.textGenerationFlag == 2; }
  ...
  public boolean isUpsideDown() { return this.textGenerationFlag == 4; }
