...
public class DXFText extends DXFEntity {
  ...
  public String getType() { return DXFConstants.ENTITY_TYPE_TEXT; }

  public boolean isOmitLineType() { return true; }

  public double getLength() { return 0; }

  public TextDocument getTextDocument() { return this.textDoc; }
   ...
   */
  public double getAlignX() { return align_p1.getX(); }
   ...
   */
  public double getAlignY() { return align_p1.getY(); }
   ...
   */
  public double getAlignZ() { return align_p1.getZ(); }
   ...
   */
  public double getObliqueAngle() { return oblique_angle; }

  /**
   * @param oblique_angle The oblique_angle to set.
   */
  public void setObliqueAngle( double oblique_angle ) { this.oblique_angle = oblique_angle; }
   ...
   */
  public boolean isAlignmentPointSet() { return alignmentPointSet; }

  public Point getInsertPoint() { return p; }

  public Point getAlignmentPoint() { return align_p1; }

  /**
   * @param alignmentPointSet The alignmentPointSet to set.
   */
  public void setAlignmentPoint( boolean alignmentPoint ) { this.alignmentPointSet = alignmentPoint; }
}
