...
public class DXFSpline extends DXFEntity {
  ...
  public Iterator<SplinePoint> getSplinePointIterator() { return points.iterator(); }
   ...
   */
  public void setControlPointSize( int controlPointSize ) { this.controlPointSize = controlPointSize; }
   ...
   */
  public void setFitPointSize( int fitPointSize ) { this.fitPointSize = fitPointSize; }
   ...
   */
  public void setNodePointsSize( int nodePointsSize ) { this.nodePointsSize = nodePointsSize; }
   ...
   */
  public void setKnotsTolerance( double knotsTolerance ) { this.knotsTolerance = knotsTolerance; }
}
