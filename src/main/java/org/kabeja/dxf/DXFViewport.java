...
public class DXFViewport extends DXFEntity {
   ...
   */
  public void setBackClippingPlane( double backClippingPlane ) { this.backClippingPlane = backClippingPlane; }
   ...
   */
  public void setCircleZoom( double circleZoom ) { this.circleZoom = circleZoom; }
   ...
   */
  public void setFastZoom( double fastZoom ) { this.fastZoom = fastZoom; }
   ...
   */
  public void setFrontClippingPlane( double frontClippingPlane ) { this.frontClippingPlane = frontClippingPlane; }
   ...
   */
  public void setGridSpacingPoint( Point gridSpacingPoint ) { this.gridSpacingPoint = gridSpacingPoint; }
   ...
   */
  public void setLensLength( double lensLength ) { this.lensLength = lensLength; }
   ...
   */
  public void setLowerLeftCorner( Point lowerLeftCorner ) { this.lowerLeftCorner = lowerLeftCorner; }
   ...
   */
  public void setViewportID( String name ) { this.viewportID = name; }
   ...
   */
  public void setAspectRatio( double ratio ) { this.ratio = ratio; }
   ...
   */
  public void setSnapBasePoint( Point snapBasePoint ) { this.snapBasePoint = snapBasePoint; }
   ...
   */
  public void setUpperRightCorner( Point upperRightCorner ) { this.upperRightCorner = upperRightCorner; }
   ...
   */
  public void setViewCenterPoint( Point viewTargetPoint ) { this.viewCenterPoint = viewTargetPoint; }
  ...
  public Bounds getBounds() {
    ...
    if ( this.viewportStatus > 0 ) {
      bounds.addToBounds( this.centerPoint.getX() - ( this.width / 2 ), this.centerPoint.getY() - ( this.height
        / 2 ), 0.0 );
      bounds.addToBounds( this.centerPoint.getX() + ( this.width / 2 ), this.centerPoint.getY() + ( this.height
        / 2 ), 0.0 );
    }
  ...
  public void setUcsOrigin( Vector ucsOrigin ) { this.ucsOrigin = ucsOrigin; }

  public Vector getUcsXAxis() { return ucsXAxis; }

  public void setUcsXAxis( Vector ucsXAxis ) { this.ucsXAxis = ucsXAxis; }

  public Vector getUcsYAxis() { return ucsYAxis; }

  public void setUcsYAxis( Vector ucsYAxis ) { this.ucsYAxis = ucsYAxis; }

  public int getUcsType() { return ucsType; }

  public void setUcsType( int ucsType ) { this.ucsType = ucsType; }

  public double getUcsElevation() { return ucsElevation; }

  public void setUcsElevation( double ucsElevation ) { this.ucsElevation = ucsElevation; }

  public boolean isUseUCS() { return useUCS; }

  public void setUseUCS( boolean useUCS ) { this.useUCS = useUCS; }
  ...
  public void setSnapAngle( double snapAngle ) { this.snapAngle = snapAngle; }

  public Point getViewTargetPoint() { return viewTargetPoint; }

  public void setViewTargetPoint( Point viewTargetPoint ) { this.viewTargetPoint = viewTargetPoint; }

  public Point getSnapSpacingPoint() { return snapSpacingPoint; }

  public void setSnapSpacingPoint( Point snapSpacingPoint ) { this.snapSpacingPoint = snapSpacingPoint; }
  ...
  public void setViewportStatus( int viewportStatus ) { this.viewportStatus = viewportStatus; }
   ...
   */
  public void setTwistAngle( double rotationAngle ) { this.twistAngle = rotationAngle; }
